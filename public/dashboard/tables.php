                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Leagues</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Nationality</th>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Club</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Rating</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Pac</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Sho</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Pas</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Dri</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Def</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Phy</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Manage</td>
                                </tr>
                            </thead>
                            <tbody class="text-gray-700 even:bg-gray-700" id="table-even">
                                ...
                                // if ($result) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "
                                            <tr>
                                                <td class='text-left py-3 px-4'>{$row['player_id']}</td>
                                                <td class='text-left py-3 px-4'>{$row['first_name']} {$row['last_name']}</td>
                                                <td class='text-left py-3 px-4'>{$row['league_name']}</td>
                                                <td class='text-left py-3 px-4'>{$row['nationality']}</td>
                                                <td class='text-left py-3 px-4'>{$row['club_name']}</td>
                                                <td class='text-left py-3 px-4'>{$row['player_rating']}</td>
                                                ...
                                                <span><a href='./edit.php?id={$row['player_id']}'><i class='fa-solid fa-pen-to-square cursor-pointer text-green-600'></i></a></span>
                                                <span><a href='./delete.php?id={$row['player_id']}'><i class='fa-solid fa-trash-can cursor-pointer text-red-600'></i></a></span>
                                                </td>
                                            </tr>
                                            ";
                                    }
